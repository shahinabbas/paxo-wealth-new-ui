...
function Disclaimer() {
  ...
  return (
    <div className="min-h-screen bg-black p-4 sm:p-8">
      <div className="max-w-4xl text-white mx-auto bg-gray-900 p-6 rounded-lg shadow-lg text-md mt-20">
        <h1 className="text-5xl font-meuthanies text-center mb-4">Disclaimer – Paxo Wealth</h1>

        <div className="text-lg ">
          

          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">1. Important Notice:</h2>
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">2. General Information:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies  text-customGreen">3. Regulatory Compliance:</h2>
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">4. Data Accuracy and Limitation of Liability:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">5. Use of AI Tools:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">6. Third-Party Content and Links:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">7. Security and Transmission Risks:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">8. Forward-Looking Statements:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">9. Updates to Disclaimer:</h2>
          <p className="text-md mt-2">
          ...
          <h2 className="text-2xl mt-10 font-meuthanies text-customGreen">10. Contact Us:</h2>
          <p className="text-md mt-2">
