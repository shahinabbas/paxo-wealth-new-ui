        ...
        <section className="px-4 py-16  text-center bg-gradient-to-b from-gray-900 to-gray-800 ">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl mt-10 mb-6 font-meuthanies">
              DirectSave – Save Big on Premium Properties{" "}
            </h1>
            <p className=" mb-8 text-gray-300 font-sf-pro">
              Get exclusive deals on properties and save up to 30% with
              DirectSave. Explore verified opportunities directly from
              developers.0% per annum. Let Paxo Wealth manage tenants and leases
              for you.
            </p>
        ...
        <section className="px-4 bg-gray-800">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl  text-center font-meuthanies ">
              Unlock Unbeatable Savings on Properties.{" "}
            </h2>
            <h1 className="text-center mb-10 mt-3">
              Save up to 30% on premium properties with exclusive deals.
            </h1>
            {/* Category Tabs */}
            <div className="mb-8">
