...
const Logo = () => (
  ...
  >
    <rect width="126" height="126" rx="16" fill="#0056E0" />
...
const StepRounds = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M20 20L1760 20.0002" stroke="#D9D9D9" />
    <path d="M20 20L290 20" stroke="#101010" />
    <circle opacity="0.2" cx="20" cy="20" r="20" fill="#101010" />
    <circle cx="20" cy="20" r="12" fill="#101010" />
    <circle cx="724" cy="20" r="12" fill="#D9D9D9" />
    <circle cx="368" cy="20" r="12" fill="#D9D9D9" />
    <circle cx="1080" cy="20" r="12" fill="#D9D9D9" />
    <circle cx="1436" cy="20" r="12" fill="#D9D9D9" />
  </svg>
);
const steps = [
  {
