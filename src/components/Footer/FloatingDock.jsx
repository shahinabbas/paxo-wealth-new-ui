  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
      ...
      <button
        ...
        className="h-10 w-10 bg-[#F3F3F3] dark:bg-neutral-800 flex items-center justify-center"
      >
        <IconChevronCompactUp className="h-5 w-5 text-customGreen " />
      </button>
    </div>
  );
};
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="aspect-square bg-[#F3F3F3]  flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
