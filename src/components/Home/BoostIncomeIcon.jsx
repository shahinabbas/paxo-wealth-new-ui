...
const BoostIncomeIcon = ({ className }) => {
  return (
    <div>
      <svg
        className={className}
      ...
      >
        ...
        />
        <path
          d="M80.6602 274.985H72.5078V283.137H80.6602V274.985Z"
          fill="white"
        />
        <path
        ...
        />
        <path
          d="M80.6602 296.258H72.5078V304.41H80.6602V296.258Z"
          fill="white"
        />
        <path
          d="M101.934 296.258H93.7812V304.41H101.934V296.258Z"
          fill="#0056E0"
        />
        <path
        ...
        />
        <path
          d="M101.934 317.536H93.7812V325.688H101.934V317.536Z"
          fill="white"
        />
        <path
          d="M146.652 274.985H138.5V283.137H146.652V274.985Z"
          fill="#0C65F5"
        />
        <path
          d="M167.926 274.985H159.773V283.137H167.926V274.985Z"
          fill="white"
        />
        <path
        ...
        />
        <path
          d="M146.652 296.258H138.5V304.41H146.652V296.258Z"
          fill="#0C65F5"
        />
        <path
          d="M167.926 296.258H159.773V304.41H167.926V296.258Z"
          fill="#0C65F5"
        />
        <path
          d="M189.203 296.258H181.051V304.41H189.203V296.258Z"
          fill="white"
        />
        <path
          d="M146.652 317.536H138.5V325.688H146.652V317.536Z"
          fill="white"
        />
        <path
        ...
        />
        <path
          d="M341.415 275.212H333.57V283.057H341.415V275.212Z"
          fill="white"
        />
        <path
        ...
        />
        <path
          d="M341.415 294.82H333.57V302.665H341.415V294.82Z"
          fill="#0C65F5"
        />
        <path
          d="M362.091 294.82H354.246V302.665H362.091V294.82Z"
          fill="white"
        />
        <path
          d="M382.767 294.82H374.922V302.665H382.767V294.82Z"
          fill="#0C65F5"
        />
        <path
        ...
        />
        <path
          d="M382.767 255.671H374.922V263.516H382.767V255.671Z"
          fill="white"
        />
        <path
          d="M341.415 314.427H333.57V322.272H341.415V314.427Z"
          fill="#0C65F5"
        />
        <path
        ...
        />
        <path
          d="M382.767 314.427H374.922V322.272H382.767V314.427Z"
          fill="white"
        />
        <path
        ...
        />
        <path
          d="M266.972 134.878H195.887V140.235H266.972V134.878Z"
          fill="white"
        />
        <path
          d="M266.972 154.77H195.887V160.126H266.972V154.77Z"
          fill="white"
        />
        <path
          d="M266.972 174.666H195.887V180.022H266.972V174.666Z"
          fill="white"
        />
        <path
          d="M266.972 194.558H195.887V199.914H266.972V194.558Z"
          fill="white"
        />
        <path
          d="M266.972 214.449H195.887V219.805H266.972V214.449Z"
          fill="white"
        />
        <path
          d="M266.971 234.34H243.172V239.696H266.971V234.34Z"
          fill="white"
        />
        <path
          d="M266.971 254.237H243.172V259.593H266.971V254.237Z"
          fill="white"
        />
        <path
          d="M266.971 274.128H243.172V279.485H266.971V274.128Z"
          fill="white"
        />
        <path
...
export default BoostIncomeIcon;
